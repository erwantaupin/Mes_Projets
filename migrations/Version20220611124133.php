 ...
 */
final class Version20220611124133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE projet_pp (id INT AUTO_INCREMENT NOT NULL, relation_id INT NOT NULL, titre VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, archive TINYINT(1) NOT NULL, lien_projet VARCHAR(255) NOT NULL, main_image VARCHAR(255) NOT NULL, lien_github VARCHAR(255) NOT NULL, INDEX IDX_811BFF173256915B (relation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
